...
public class RegisterServiceImpl implements RegisterService {
    ...
    @Override
    public Map<String, String> register(String username, String password, String confirmedPassword,String authority) {
        QueryWrapper<User> queryWrapper =new QueryWrapper<>();
        queryWrapper.eq("username",username);
        Map<String,String> map=new HashMap<>();
        System.out.println(username+" "+password+" "+confirmedPassword+" "+authority+".");
