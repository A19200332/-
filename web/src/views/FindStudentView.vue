        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <select class="form-select" aria-label="Default select example" id="majorname2" v-model="gmajor">
                                    ...
                                    <form @submit.prevent="add">
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" aria-label="Default select example" id="major1"
                                                    v-model="addmajor">
