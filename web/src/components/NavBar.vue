<template>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <router-link class="navbar-brand" :to="{ name: 'home' }">城市公交查询系统</router-link>
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <router-link :class="rout_name == 'home' ? 'nav-link activeli' : 'nav-link'"
                        :to="{ name: 'home' }">公交线路查询</router-link>
                </li>
                <!-- <li class="nav-item">
